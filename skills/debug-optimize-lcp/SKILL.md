...
description: Debug and optimize Largest Contentful Paint (LCP) with Chrome DevTools MCP. Use for slow page loads, Core Web Vitals ("CWV"), "largest contentful paint", "page load speed", or slow hero-image/main-content rendering.
---
